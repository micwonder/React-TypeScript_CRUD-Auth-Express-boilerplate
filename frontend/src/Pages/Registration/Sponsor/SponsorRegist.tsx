...
import SponsorStep01 from './SponsorStep01'
import SponsorStep02 from './SponsorStep02'
...
const SponsorRegist = () => {
  ...
  return (
    <div className="p-[20px]">
      ...
      {step === 1 && <SponsorStep01 handleNext={() => setStep(2)} />}
      {step === 2 && <SponsorStep02 handleNext={() => setStep(3)} />}
      {step === 3 && <RegistFinal />}
    </div>
  )
}

export default SponsorRegist
